...
python scripts/prepare_data.py fleurs   --languages de_de es_419 ko_kr --max-hours 1.5
python scripts/prepare_data.py fleurs_r --languages de_de es_419 ko_kr --max-hours 1.0
